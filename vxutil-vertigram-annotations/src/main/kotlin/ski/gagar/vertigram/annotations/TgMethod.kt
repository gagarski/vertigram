 ...
 *
 * Used for code generation in [ski.gagar.vxutil.vertigram.TgMethodsKt].
 ...
 *  object is used. See [ski.gagar.vxutil.vertigram.methods.SendPoll] as an example. This won't allow you to use power
 *  of default values fully but still a reasonable trade-off to make [ski.gagar.vxutil.vertigram.TgMethodsKt]
 *  generatable.
 */
