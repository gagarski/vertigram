 ...
 *
 * It represents either `InputFile` type from Telegram API or a value of [ski.gagar.vertigram.types.InputMedia.media].
 *
 ...
 *  - [ski.gagar.vertigram.methods.SendMediaGroup] has a way of attaching multiple files.
 *   `media` field there,  is a JSON descriptor, a list of [ski.gagar.vertigram.types.InputMedia].
 *   Each [ski.gagar.vertigram.types.InputMedia] has [ski.gagar.vertigram.types.InputMedia.media] field itself,
