...
/**
 * Use this method to send audio files that can be displayed as playable voice messages.
 *
 * See Telegram's [sendVoice](https://core.telegram.org/bots/api#sendvoice) documentation.
 */
@Throttled
