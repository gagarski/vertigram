 ...
 *
 * Used in [ski.gagar.vertigram.telegram.types.ChatMember.Banned] and
 * [ski.gagar.vertigram.telegram.types.ChatMember.Restricted] to deal with Telegram strange formats for these dates
 */
